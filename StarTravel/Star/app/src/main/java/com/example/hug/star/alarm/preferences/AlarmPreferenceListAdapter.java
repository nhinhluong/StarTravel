package com.example.hug.star.alarm.preferences;
...
import com.example.hug.star.alarm.preferences.AlarmPreference.Type;
...
//		
	...
	public void setMathAlarm(Alarm alarm) {
		...
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_NAME, "Plan:", alarm.getAlarmName(), null, alarm.getAlarmName(), Type.STRING));
		...
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_REPEAT, "Repeat at:", alarm.getRepeatDaysString(), repeatDays, alarm.getDays(),Type.MULTIPLE_LIST));
		...
		if(alarmTone instanceof Ringtone && !alarm.getAlarmTonePath().equalsIgnoreCase("")){
			preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_TONE, "Alarm", alarmTone.getTitle(getContext()),alarmTones, alarm.getAlarmTonePath(), Type.LIST));
		}else{
			preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_TONE, "Alarm", getAlarmTones()[0],alarmTones, null, Type.LIST));
		}
