...
import com.example.hug.star.alarm.BaseActivity;
import com.example.hug.star.alarm.database.Database;
import com.example.hug.star.alarm.preferences.AlarmPreference.Key;
...
public class AlarmPreferencesActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		layout = (LinearLayout)findViewById(R.id.alarm_pre);
        layout.setBackgroundResource(R.drawable.book2);
